...
class ModAbVar_ambient_jacobian_class(ModularAbelianVariety_modsym_abstract):
    ...
    def __init__(self, group):
        ...
        EXAMPLES::
            ...
            sage: type(A)
            <class 'sage_modabvar.abvar_ambient_jacobian.ModAbVar_ambient_jacobian_class_with_category'>
            sage: A.group()
    ...
    def group(self):
        ...
        EXAMPLES::
            ...
            sage: from sage_modabvar.abvar_ambient_jacobian import ModAbVar_ambient_jacobian
            sage: J = ModAbVar_ambient_jacobian(GammaH(11,[3])); J
    ...
    def degeneracy_map(self, level, t=1, check=True):
        ...
        Jdest = ModAbVar_ambient_jacobian((type(Mself.group()))(level))
